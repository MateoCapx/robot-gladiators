...
// console.log(playerInfo.name + " is ready for battle!");   // Example of string concatenation 

// // "Your robot, Tony the Robot, has won!
// console.log("Your robot, " + playerInfo.name + ", has won!");      // Example of string concatenation 
